...
export const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-white p-6 flex flex-col pt-[60px]">
       ...
       <h1 className="text-[30px] font-bold font-['Poppins'] mb-2 text-left">Reset password</h1>
       ...
       <form className="flex flex-col gap-4 mb-8">
         ...
         <Button className="mt-4" onClick={() => navigate('/password-changed')}>Reset password</Button>
       </form>
